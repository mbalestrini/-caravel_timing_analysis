...
puts "\n\n***** CHECKS wrapped_hack_soc_6 *****"
report_checks -path_delay min -fields {slew cap input nets fanout} -format full_clock_expanded -group_count 2 -through mprj/wrapped_hack_soc_6
report_checks -path_delay max -fields {slew cap input nets fanout} -format full_clock_expanded -group_count 2 -through mprj/wrapped_hack_soc_6

puts "\n\n***** CHECKS wrapped_wishbone_demo_13 *****"
report_checks -path_delay min -fields {slew cap input nets fanout} -format full_clock_expanded -group_count 2 -through mprj/wrapped_wishbone_demo_13
