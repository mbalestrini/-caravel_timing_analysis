...
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/user_project_wrapper.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapper_fibonacci.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_quad_pwm_fet_drivers.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_qarma.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_pong.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_newmot.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_memLCDdriver.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_chacha_wb_accel.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_a51.lvs.powered.v;
read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/fbless_graphics_core.lvs.powered.v;

#read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_rgb_mixer.lvs.powered.v
#read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_spell.lvs.powered.v
#read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_ppm_coder.lvs.powered.v
#read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_ppm_decoder.lvs.powered.v
#read_verilog /project_files/zero_to_asic_MPW2_rerun/verilog/gl/wrapped_frequency_counter.lvs.powered.v


link_design caravel;

# Current project SPEF files
read_spef -path mprj /project_files/zero_to_asic_MPW2_rerun/timing/23-user_project_wrapper.spef
read_spef -path mprj/wrapper_fibonacci_3    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapper_fibonacci.spef
read_spef -path mprj/wrapped_quad_pwm_fet_drivers_5    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_quad_pwm_fet_drivers.spef
read_spef -path mprj/wrapped_qarma_8    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_qarma.spef
read_spef -path mprj/wrapped_pong_4    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_pong.spef
read_spef -path mprj/wrapped_newmot_15    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_newmot.spef
read_spef -path mprj/wrapped_memLCDdriver_7    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_memLCDdriver.spef
#read_spef -path mprj/wrapped_frequency_counter    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_frequency_counter.spef
read_spef -path mprj/wrapped_chacha_wb_accel_9    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_chacha_wb_accel.spef
read_spef -path mprj/wrapped_a51_2    /project_files/zero_to_asic_MPW2_rerun/timing/21-wrapped_a51.spef
read_spef -path mprj/fbless_graphics_core_10    /project_files/zero_to_asic_MPW2_rerun/timing/21-fbless_graphics_core.spef
...
puts "\n\n***** CHECKS mprj *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj  -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapper_fibonacci_3 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapper_fibonacci_3 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapper_fibonacci_3 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_quad_pwm_fet_drivers_5 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_quad_pwm_fet_drivers_5 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_quad_pwm_fet_drivers_5 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_qarma_8 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_qarma_8 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_qarma_8 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_pong_4 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_pong_4 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_pong_4 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_newmot_15 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_newmot_15 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_newmot_15 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_memLCDdriver_7 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_memLCDdriver_7 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_memLCDdriver_7 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_chacha_wb_accel_9 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_chacha_wb_accel_9 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_chacha_wb_accel_9 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/wrapped_a51_2 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_a51_2 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/wrapped_a51_2 -slack_max 0.0001

puts "\n\n***** CHECKS mprj/fbless_graphics_core_10 *****"
puts "MIN"
report_checks -path_delay min -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/fbless_graphics_core_10 -slack_max 0.0001
puts "MAX"
report_checks -path_delay max -fields {slew cap input nets fanout} -format summary -group_count 10 -through mprj/fbless_graphics_core_10 -slack_max 0.0001
